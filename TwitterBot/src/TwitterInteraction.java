...
public class TwitterInteraction {
	...
	TwitterInteraction() {
		...
		try {
			...
			cb.setDebugEnabled(true).setOAuthConsumerKey("Qc9KxYdf89HhCSZC0B5ycYQWv") //API Key here
					.setOAuthConsumerSecret("T0Bs7WYHNeHaEaEqamcyKzwcCBuIxsgL9kNqqUXyYqkdO9sbHW") //Secret key here
					.setOAuthAccessToken("1060579069371260930-GOPqdW5DloMzIvwKfzQItRnQWhkUv9") //access token here
					.setOAuthAccessTokenSecret("nlskwS9E3UTBaxGS370ksB7T2lNWj3Y6uJ4GYnneKU0IU"); //secret access token here
